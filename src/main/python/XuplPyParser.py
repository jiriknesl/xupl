...
class XuplPyParser(Parser):
    ...
    def __init__(self, input, state=None, *args, **kwargs):
        ...
        super(XuplPyParser, self).__init__(input, state, *args, **kwargs)
    ...
    # $ANTLR start "xupl"
    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:8:1: xupl : (xml= xmldecl )? (doctype= DOC )? node EOF ;
    def xupl(self, ):
        ...
        try:
            try:
                # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:9:5: ( (xml= xmldecl )? (doctype= DOC )? node EOF )
                # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:9:7: (xml= xmldecl )? (doctype= DOC )? node EOF
                pass 
                # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:9:10: (xml= xmldecl )?
                alt1 = 2
                ...
                if alt1 == 1:
                    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:9:10: xml= xmldecl
                    pass 
                    self._state.following.append(self.FOLLOW_xmldecl_in_xupl29)
                    xml = self.xmldecl()
                ...
                # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:10:14: (doctype= DOC )?
                alt2 = 2
                ...
                if alt2 == 1:
                    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:10:14: doctype= DOC
                    pass 
                    doctype=self.match(self.input, DOC, self.FOLLOW_DOC_in_xupl40)



                self._state.following.append(self.FOLLOW_node_in_xupl49)
                self.node()

                self._state.following.pop()
                self.match(self.input, EOF, self.FOLLOW_EOF_in_xupl51)
    ...
    # $ANTLR start "xmldecl"
    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:14:1: xmldecl returns [String attrs] : XML attributes '.' ;
    def xmldecl(self, ):
        ...
        try:
            try:
                # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:15:5: ( XML attributes '.' )
                # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:15:7: XML attributes '.'
                pass 
    ...
    # $ANTLR start "node"
    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:18:1: node : (tagname= tag children | text= STR );
    def node(self, ):
        ...
        try:
            try:
                # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:19:5: (tagname= tag children | text= STR )
                alt3 = 2
                ...
                if alt3 == 1:
                    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:19:7: tagname= tag children
                    pass 
                    ...
                    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:22:7: text= STR
                    pass 
    ...
    # $ANTLR start "tag"
    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:26:1: tag returns [String tagname] : nodename= ID ( ( '@' | '\\\\' ) ns= ID )? ( attributes )? ;
    def tag(self, ):
        ...
        try:
            try:
                # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:27:5: (nodename= ID ( ( '@' | '\\\\' ) ns= ID )? ( attributes )? )
                # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:27:7: nodename= ID ( ( '@' | '\\\\' ) ns= ID )? ( attributes )?
                pass 
                nodename=self.match(self.input, ID, self.FOLLOW_ID_in_tag150)
                # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:27:19: ( ( '@' | '\\\\' ) ns= ID )?
                alt4 = 2
                ...
                if ((17 <= LA4_0 <= 18)) :
                    alt4 = 1
                if alt4 == 1:
                    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:27:20: ( '@' | '\\\\' ) ns= ID
                    pass 
                ...
                # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:27:39: ( attributes )?
                alt5 = 2
    ...
    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:30:10: fragment children : ( '{' childs '}' | ( ':' ( node )* )? ( '.' | ';' ) );
    def children(self, ):

        try:
            try:
                # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:31:5: ( '{' childs '}' | ( ':' ( node )* )? ( '.' | ';' ) )
                alt8 = 2
                ...
                if alt8 == 1:
                    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:31:7: '{' childs '}'
                    pass 
                    ...
                    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:32:7: ( ':' ( node )* )? ( '.' | ';' )
                    pass 
                    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:32:7: ( ':' ( node )* )?
                    alt7 = 2
                    ...
                    if (LA7_0 == 21) :
                        alt7 = 1
                    if alt7 == 1:
                        # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:32:8: ':' ( node )*
                        pass 
                        self.match(self.input, 21, self.FOLLOW_21_in_children197)
                        # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:32:12: ( node )*
                        while True: #loop6
                            alt6 = 2
    ...
    # $ANTLR start "childs"
    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:35:10: fragment childs : ( node )* (nodename= tag )? ;
    def childs(self, ):
        ...
        try:
            try:
                # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:36:5: ( ( node )* (nodename= tag )? )
                # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:36:7: ( node )* (nodename= tag )?
                pass 
                # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:36:7: ( node )*
                while True: #loop9
                    alt9 = 2
                    ...
                    if alt9 == 1:
                        ...
                        break #loop9
                # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:36:21: (nodename= tag )?
                alt10 = 2
    ...
    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:39:10: fragment attribute : ( (ns= ID ( '!' | '#' ) name= ID | name= ID ( ( '@' | '\\\\' ) ns= ID )? ) (o= OP )? (v= value )? | v= value (o= OP )? (ns= ID ( '!' | '#' ) name= ID | name= ID ( ( '@' | '\\\\' ) ns= ID )? )? );
    def attribute(self, ):
        ...
        try:
            try:
                # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:40:5: ( (ns= ID ( '!' | '#' ) name= ID | name= ID ( ( '@' | '\\\\' ) ns= ID )? ) (o= OP )? (v= value )? | v= value (o= OP )? (ns= ID ( '!' | '#' ) name= ID | name= ID ( ( '@' | '\\\\' ) ns= ID )? )? )
                alt18 = 2
                ...
                if alt18 == 1:
                    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:40:7: (ns= ID ( '!' | '#' ) name= ID | name= ID ( ( '@' | '\\\\' ) ns= ID )? ) (o= OP )? (v= value )?
                    pass 
                    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:40:7: (ns= ID ( '!' | '#' ) name= ID | name= ID ( ( '@' | '\\\\' ) ns= ID )? )
                    alt12 = 2
                    ...
                    if alt12 == 1:
                        # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:40:8: ns= ID ( '!' | '#' ) name= ID
                        pass 
                        ...
                        # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:40:34: name= ID ( ( '@' | '\\\\' ) ns= ID )?
                        pass 
                        name=self.match(self.input, ID, self.FOLLOW_ID_in_attribute271)
                        # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:40:42: ( ( '@' | '\\\\' ) ns= ID )?
                        alt11 = 2
                        ...
                        if ((17 <= LA11_0 <= 18)) :
                            alt11 = 1
                        if alt11 == 1:
                            # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:40:44: ( '@' | '\\\\' ) ns= ID
                            pass 
                            if (17 <= self.input.LA(1) <= 18):
                                self.input.consume()
                                self._state.errorRecovery = False
                    ...
                    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:40:65: (o= OP )?
                    alt13 = 2
                    ...
                    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:40:71: (v= value )?
                    alt14 = 2
                    ...
                    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:41:7: v= value (o= OP )? (ns= ID ( '!' | '#' ) name= ID | name= ID ( ( '@' | '\\\\' ) ns= ID )? )?
                    pass 
                    self._state.following.append(self.FOLLOW_value_in_attribute306)
                    v = self.value()

                    self._state.following.pop()
                    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:41:16: (o= OP )?
                    alt15 = 2
                    ...
                    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:41:21: (ns= ID ( '!' | '#' ) name= ID | name= ID ( ( '@' | '\\\\' ) ns= ID )? )?
                    alt17 = 3
                    ...
                    if (LA17_0 == ID) :
                        ...
                        if ((23 <= LA17_1 <= 24)) :
                            ...
                            alt17 = 2
                    if alt17 == 1:
                        # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:41:22: ns= ID ( '!' | '#' ) name= ID
                        pass 
                        ...
                        # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:41:49: name= ID ( ( '@' | '\\\\' ) ns= ID )?
                        pass 
                        name=self.match(self.input, ID, self.FOLLOW_ID_in_attribute333)
                        # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:41:57: ( ( '@' | '\\\\' ) ns= ID )?
                        alt16 = 2
                        ...
                        if ((17 <= LA16_0 <= 18)) :
                            alt16 = 1
                        if alt16 == 1:
                            # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:41:58: ( '@' | '\\\\' ) ns= ID
                            pass 
                            if (17 <= self.input.LA(1) <= 18):
                                self.input.consume()
                                self._state.errorRecovery = False
    ...
    # $ANTLR start "value"
    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:44:10: fragment value returns [Token value] : ( STR | INT | FLOAT | CHAR ) ;
    def value(self, ):
        ...
        try:
            try:
                # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:45:5: ( ( STR | INT | FLOAT | CHAR ) )
                # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:45:7: ( STR | INT | FLOAT | CHAR )
                pass 
    ...
    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:48:10: fragment attributes : ( attribute ( ',' attribute )* | '(' attribute ( ( ',' | ';' | '.' ) attribute )* ')' | '[' attribute ( ( ',' | ';' | '.' ) attribute )* ']' );
    def attributes(self, ):

        try:
            try:
                # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:49:5: ( attribute ( ',' attribute )* | '(' attribute ( ( ',' | ';' | '.' ) attribute )* ')' | '[' attribute ( ( ',' | ';' | '.' ) attribute )* ']' )
                alt22 = 3
                ...
                if alt22 == 1:
                    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:49:7: attribute ( ',' attribute )*
                    pass 
                    self._state.following.append(self.FOLLOW_attribute_in_attributes404)
                    self.attribute()

                    self._state.following.pop()
                    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:49:17: ( ',' attribute )*
                    while True: #loop19
                        alt19 = 2
                        ...
                        if alt19 == 1:
                            # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:49:19: ',' attribute
                            pass 
                    ...
                    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:50:7: '(' attribute ( ( ',' | ';' | '.' ) attribute )* ')'
                    pass 
                    ...
                    self._state.following.pop()
                    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:50:21: ( ( ',' | ';' | '.' ) attribute )*
                    while True: #loop20
                        alt20 = 2
                        ...
                        if alt20 == 1:
                            # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:50:23: ( ',' | ';' | '.' ) attribute
                            pass 
                    ...
                    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:51:7: '[' attribute ( ( ',' | ';' | '.' ) attribute )* ']'
                    pass 
                    ...
                    self._state.following.pop()
                    # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:51:21: ( ( ',' | ';' | '.' ) attribute )*
                    while True: #loop21
                        alt21 = 2
                        ...
                        if alt21 == 1:
                            # /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplPy.g:51:23: ( ',' | ';' | '.' ) attribute
                            pass 
                            if self.input.LA(1) == 16 or self.input.LA(1) == 22 or self.input.LA(1) == 25:
                                self.input.consume()
                                self._state.errorRecovery = False
    ...
    FOLLOW_xmldecl_in_xupl29 = frozenset([4, 6, 7])
    FOLLOW_DOC_in_xupl40 = frozenset([4, 6, 7])
    FOLLOW_node_in_xupl49 = frozenset([])
    FOLLOW_EOF_in_xupl51 = frozenset([1])
...
def main(argv, stdin=sys.stdin, stdout=sys.stdout, stderr=sys.stderr):
    ...
    main = ParserMain("XuplPyLexer", XuplPyParser)
    main.stdin = stdin
    main.stdout = stdout
    main.stderr = stderr
    main.execute(argv)
