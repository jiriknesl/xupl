// $ANTLR 3.3 Nov 30, 2010 12:46:29 /Users/Shared/Dropbox/workspace/projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplObjC.g 2011-04-19 00:05:01
...
@interface XuplObjCParser_name_return :ANTLRParserRuleReturnScope { /* returnScopeInterface line 1806 */
 /* start of memVars() */
Token namespace;
Token nodename;
}
...
/* end properties */
+ (XuplObjCParser_name_return *)newXuplObjCParser_name_return;
...
@interface XuplObjCParser : ANTLRParser { /* line 572 */
...
- (void)childs; 
- (void)attribute; 
- (XuplObjCParser_name_return *)name; 
- (Token)ns; 
- (String)value; 
- (void)attributes; 


@end /* end of XuplObjCParser interface */
