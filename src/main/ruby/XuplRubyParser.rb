#!/usr/bin/env ruby
#
# /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplRuby.g
# --
# Generated using ANTLR version: 3.3 Nov 30, 2010 12:45:30
# Ruby runtime library version: 1.8.1
# Input grammar file: /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplRuby.g
...
module XuplRuby
  ...
  class Parser < ANTLR3::Parser
    @grammar_home = XuplRuby

    RULE_METHODS = [ :xupl, :xmldecl, :node, :tag, :children, :childs, 
    ...
    begin
      generated_using( "/Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplRuby.g", "3.3 Nov 30, 2010 12:45:30", "1.8.1" )
    ...
    # parser rule xupl
    # 
    # (in /Users/rnix/Projects/github.com/text-plain/xupl/xupl.parsers/src/main/antlr/XuplRuby.g)
    # 7:1: xupl returns [XuplRubyParser self] : (xml= xmldecl )? (doctype= DOC )? node EOF ;
    # 
    def xupl
      ...
      begin
        ...
        when 1
          # at line 8:10: xml= xmldecl
          @state.following.push( TOKENS_FOLLOWING_xmldecl_IN_xupl_32 )
          xmldecl
          @state.following.pop
        ...
        when 1
          # at line 9:14: doctype= DOC
          doctype = match( DOC, TOKENS_FOLLOWING_DOC_IN_xupl_43 )

        end
        @state.following.push( TOKENS_FOLLOWING_node_IN_xupl_52 )
        node
        @state.following.pop
        match( EOF, TOKENS_FOLLOWING_EOF_IN_xupl_54 )
    ...
    TOKENS_FOLLOWING_xmldecl_IN_xupl_32 = Set[ 4, 6, 9, 11, 12, 13, 14 ]
    TOKENS_FOLLOWING_DOC_IN_xupl_43 = Set[ 4, 6, 9, 11, 12, 13, 14 ]
    TOKENS_FOLLOWING_node_IN_xupl_52 = Set[  ]
    TOKENS_FOLLOWING_EOF_IN_xupl_54 = Set[ 1 ]
